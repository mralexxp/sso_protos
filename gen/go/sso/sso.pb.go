...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // токен авторизации
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // email пользователя
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // пароль пользователя
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // Выбираем id сервиса, в который логинимся?
}
